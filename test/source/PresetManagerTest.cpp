...
protected:
    StochasticModel testModel; // Model used for testing save/load operations.
    ...
    void populateTestModel(StochasticModel& model)
    {
...
TEST_F(PresetManagerTest, SavePresetSavesCorrectGlobalParameters)
{
    ...
    EXPECT_EQ(static_cast<StochasticModel::TemporalDistribution>(globalParams["temporalDistribution"].get<int>()), testModel.getGlobalTemporalDistribution());
...
{
    StochasticModel modelToLoadInto; // Fresh model for loading into.
    ...
    presetJson["global"]["temporalDistribution"] = static_cast<int>(StochasticModel::TemporalDistribution::Uniform);
    ...
    EXPECT_EQ(modelToLoadInto.getGlobalTemporalDistribution(), StochasticModel::TemporalDistribution::Uniform);
...
{
    StochasticModel modelToLoadInto;
